...
<body>
  ...
  <a href="https://lykcloud.me" target="_self">Fork me on GitHub</a>
</body>`
...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://FreeCode911.github.io/Url-Shorten-Worker/theme/urlcool/index.html")
  ...
  if (location) {
    if (config.safe_browsing_api_key){
      if(!(await is_url_safe(location))){
        let warning_page = await fetch("https://FreeCode911.github.io/Url-Shorten-Worker/safe-browsing.html")
    ...
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://FreeCode911.github.io/Url-Shorten-Worker/no-ref.html")
